      ...
      <div className="container fluid py-2">
            ...
            <Form.Group className="mb-3" controlId="exampleForm.ControlInput1">
              ...
              <Form.Label for="measurment"><strong>Measurement</strong></Form.Label>
                ...
                <Form.Group className="text-left mb-3" controlId="exampleForm.ControlInput1">
                <Row> 
                <Col md="4">
                  <Form.Label for="total"><strong>Total Additional Charges</strong></Form.Label>
                  </Col>
                  <Col md="4">
                  <Form.Control
                  id = "total"
         ...
         <div className='form-group  mt-4 offset-3 text-center'>
        <button type="button" class="btn btn-dark" onClick={this.openAddCharge}>ADD</button>
        </div>    
